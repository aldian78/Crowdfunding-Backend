...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	if err != nil {
		...
		//http.sttusUnproccess jika validasi datanya gagal / entitynya tidak bisa diproses
...
func (h *userHandler) Login(c *gin.Context) {
	...
	// ditangkap oleh handler
	// mapping user input ke user struct
	// passing struct ke service
...
func (h *userHandler) IsEmailAvailable(c *gin.Context) {
	var input user.IsEmailAvailabity
	...
	metaMessage := "Email has ben registed"
	if isEmailAvailable {
...
func (h *userHandler) UploadAvatar(c *gin.Context) {
	//tangkapa input dari form bukan json
...
func (h *userHandler) FetchUser(c *gin.Context) {
	...
	response := helper.APIResponse("Succefuly fetch user data", http.StatusOK, "success", formatter)
